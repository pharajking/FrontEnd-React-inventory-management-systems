                    ...
                    <div className="card bg-theme">
                        ...
                        <div className="card-body">
                            ...
                            <div className="d-grid mt-4">
                                <button onClick={handleLogin} className={'btn btn-outline-warning'} dangerouslySetInnerHTML={{__html: isLoading ? '<span class="spinner-grow spinner-grow-sm" aria-hidden="true"></span> Login...': 'Login'}}/>
                            </div>
                        </div>
                    </div>
                </div>
