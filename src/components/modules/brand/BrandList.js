               ...
               <table className={'my-table table table-hover table-striped table-bordered'}>
                 ...
                 <tbody>
                   {Object.keys(categories).length > 0 ? categories.map((brand, index)=> (
                       ...
                       <td>
                         <img onClick={()=>handlePhotoModal(brand.photo_full)} src={brand.photo} alt={brand.name} className={'img-thumbnail table-image'}/>
                       ...
                       <td>
                         <button onClick={()=>handleDetailsModal(brand)} className={'btn btn-sm btn-info my-1'}><i className="fa-solid fa-eye"></i></button>
                         <Link to={`/brand/edit/${brand.id}`}><button className={'btn btn-sm btn-warning my-1 mx-1'}><i className="fa-solid fa-edit"></i></button></Link>
                         <button onClick={()=>handleBrandDelete(brand.id)} className={'btn btn-sm btn-danger my-1'}><i className="fa-solid fa-trash"></i></button>
                       </td>
                     </tr>
                   )): <NoDataFound/> }
