              ...
              <div className="col-md-12">
                <div className="row justify-content-center">
                  ...
                  <div className="d-grid mt-4">
                   <button className={'btn theme-button'} onClick={handleBrandUpdate} dangerouslySetInnerHTML={{__html: isLoading ? '<span class="spinner-grow spinner-grow-sm" aria-hidden="true"></span> Loading...': 'Update Brand'}}/>
                  </div>
